...
#   powershell -NoProfile -ExecutionPolicy Bypass -File "D:\cursor\work\super-agent\scripts\deploy-utility-dict-putty.ps1"
# Or:
#   powershell -NoProfile -ExecutionPolicy Bypass -File "...\deploy-utility-dict-putty.ps1" -SSHPassword 'your-password'
...
Write-Host '========== Change set ==========' -ForegroundColor Cyan
Write-Host ' M src/components/DictionaryPanel.tsx'
Write-Host '?? src/components/DictionaryUtilityViews.tsx'
Write-Host 'Frontend only: pnpm build + upload dist + nginx reload'
Write-Host ''
