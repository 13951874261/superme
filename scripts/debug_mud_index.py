...
def debug():
    ...
    async function test() {
      ...
      if (posLineMatch) {
        ...
        const nonDefinitionPattern = /^(uk|us|your browser|[\\/\\\\][\\w\u02c8\u02cc\u026a\u028a\u025b\u00e6\u0251\u0254\u0259\u028c\u026a\u02d0]+[\\/\\\\]|add to word list|idioms?)$/i;
        ...
        console.log("definitionIndex:", definitionIndex);
        if (definitionIndex >= 0) {
          console.log("matched line:", lines[definitionIndex]);
        }
      }
    }
