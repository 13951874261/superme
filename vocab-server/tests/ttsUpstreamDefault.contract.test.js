...
const NEW = 'http://192.210.136.140:20128/v1/audio/speech';

assert.ok(src.includes(`TTS_API_URL || '${NEW}'`), 'TTS_API_URL default must be new speech endpoint');
assert.ok(src.includes(`TTS_API_FALLBACK_URL || '${NEW}'`), 'TTS_API_FALLBACK_URL default must be new speech endpoint');
