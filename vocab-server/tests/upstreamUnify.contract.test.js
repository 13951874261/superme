...
assert.strictEqual(llm.DEFAULT_LLM_URL, 'http://150.158.34.217:38000/v1/chat/completions');
...
assert.ok(webSrc.includes("FETCH_ENDPOINT_BASE || 'http://192.210.136.140:20128/v1'"), 'web fetch default must use the confirmed upstream');
