...
const GT_FALLBACK_SUGGESTED = '先确认对方关切，再说明边界与可协商空间的下一句';

function isFallbackToneSuggested(suggested) {
...
/** 检查文本中是否贴合用户当句核心子串 */
function matchUserPromptCue(targetText, rawUserInput) {
...
function evaluateSimAdviceQuality(input) {
