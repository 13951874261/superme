...
import { AlertTriangle, Globe, Target, Users } from 'lucide-react';
...
export default function OralWarRoomSituationPanel({
  ...
  return (
    <aside className={`flex flex-col gap-4 h-full ${isContextPanelOpen ? '2xl:col-span-3' : '2xl:col-span-4'}`}>
          ...
          {/* 沙盘标准结构清单 */}
          <div className="bg-white rounded-[1.5rem] xl:rounded-[2rem] p-4 xl:p-5 border border-gray-100 shadow-sm">
            <div className="text-[9px] font-black uppercase tracking-widest text-[#FF5722] mb-3 flex items-center gap-1.5">
          ...
          <div className="bg-white rounded-[1.5rem] xl:rounded-[2rem] p-5 xl:p-6 border border-gray-100 shadow-sm flex-1 overflow-y-auto">
            <div className="text-[10px] font-black uppercase tracking-widest text-[#202124] flex items-center justify-between mb-4">
